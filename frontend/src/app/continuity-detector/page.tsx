    ...
    <div className="space-y-6">
      ...
      {activePlan === "free" ? (
        <div className="relative rounded-2xl border border-accent/20 bg-accent/5 overflow-hidden p-8 text-center max-w-2xl mx-auto shadow-2xl space-y-6 my-12 backdrop-blur-md">
          ...
          <h2 className="text-3xl font-display font-bold tracking-tight text-foreground">Continuity Detector Locked</h2>
          <p className="text-sm text-muted-foreground leading-relaxed max-w-md mx-auto">
            The frame-by-frame visual continuity agent uses advanced multimodal Gemini models to evaluate wardrobe, props, and lighting. This feature is exclusive to the **Pro Studio** plan.
          </p>
