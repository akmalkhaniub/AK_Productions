...
import { Network, Database, RefreshCw, AlertTriangle, CheckCircle, Plus, BookOpen, Layers, User, Trash2, Tag, Calendar, Play, ShieldAlert } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      {activePlan !== "enterprise" ? (
        <div className="relative rounded-2xl border border-sky-500/20 bg-sky-950/5 overflow-hidden p-8 text-center max-w-2xl mx-auto shadow-2xl space-y-6 my-12 backdrop-blur-md">
          <div className="mx-auto w-16 h-16 bg-sky-500/10 border border-sky-500/20 rounded-full flex items-center justify-center text-sky-400 mb-4">
            <ShieldAlert className="h-8 w-8 animate-pulse" />
          </div>
          <h2 className="text-3xl font-display font-bold tracking-tight text-foreground font-sans">Series Ingestion Locked</h2>
          <p className="text-sm text-muted-foreground leading-relaxed max-w-md mx-auto font-sans">
            The Batch Ingestion & Narrative Intelligence swarm builds consolidated lore bibles and flags script timeline contradictions across episodes. This feature is exclusive to the **Enterprise Swarm** plan.
          </p>
